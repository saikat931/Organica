...
<main>
  <article>
    ...
    <!-- 
        All Trending Organic Products
      -->

    <section class="about section product">
      <div class="container">

        <p class="section-subtitle"> -- Organic Products --</p>

        <h2 class="h2 section-title">All Trending Organic Products</h2>
        ...
        <ul class="grid-list active">
          ...
          <li>
            <div class="product-card">
              ...
              <figure class="card-banner">
                <img src="./assets/images/product-3.png" width="189" height="189" loading="lazy" alt="Fresh Watermelon">
